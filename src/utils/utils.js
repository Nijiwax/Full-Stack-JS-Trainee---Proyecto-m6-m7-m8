...
export const readDataJson = (filename) => {
    ...
    if(!fs.existsSync(pathFile)){
        throw new Error("Error al intentar leer los datos usuarios, porque no existe ningún archivo llamado:" + filename);
    }
...
export const writeDataJson = (filename, data) => {
    ...
    if(!fs.existsSync(pathFile)){
        throw new Error("Error al intentar guardar los datos usuarios, porque no existe ningún archivo llamado:" + filename);
    }
